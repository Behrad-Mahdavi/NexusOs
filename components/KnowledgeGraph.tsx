                                    ...
                                    <div className="flex flex-col gap-2">
                                        {[1, 2, 3].map((catId) => (
                                            <button
                                                ...
                                                className={`w-full p-3 rounded-xl border text-left text-sm transition-all ${group === catId
                                        ...
                                        {graphData.nodes
                                            ...
                                            .map(node => (
                                                <button
                                                    ...
                                                    className={`w-full flex items-center justify-between px-3 py-2 rounded-lg text-xs transition-colors ${connections.includes(node.id)
