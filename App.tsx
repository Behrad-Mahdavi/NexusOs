...
const App: React.FC = () => {
  ...
  return (
    <div className={`relative w-screen h-screen overflow-hidden text-white selection:bg-pink-500/30 ${language === 'fa' ? 'font-persian' : 'font-sans'}`}>
      <AuroraBackground />
      ...
      {!session ? (
        ...
        <>
            <main className="relative z-10 w-full h-full pt-4 pb-24 max-w-7xl mx-auto">
